...
//        int lastIndex = calculateCharacters(secondWord)-secondWord.length();
...
//        int lastIndex = firstWord.lastIndexOf(secondWord.length());
        ...
        if (firstWord.contains(secondWord)){
            System.out.println("The word '"+ Arrays.toString(firstWord.split(secondWord, secondWord.length())) +"' is found in the word '"+firstWord+"'.");
        } else {

...
public class Ex23_Graph {
    ...
    public static Ex23_Graph instance;

    public static Ex23_Graph getInstance() {
        if (instance == null)
            instance = new Ex23_Graph("Graph");
        return instance;
    }
